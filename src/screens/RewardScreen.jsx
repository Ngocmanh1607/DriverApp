    ...
    return (
        <View style={styles.container}>
            ...
            <View style={styles.filterContainer}>
                ...
                <TouchableOpacity
                    style={[styles.filterButton, selectedCategory === 'voucher' && styles.filterButtonActive]}
                    onPress={() => setSelectedCategory('voucher')}
                >
                    <Text style={[styles.filterText, selectedCategory === 'voucher' && styles.filterTextActive]}>
                        Voucher
                    </Text>
                </TouchableOpacity>
                <TouchableOpacity
                    style={[styles.filterButton, selectedCategory === 'phone' && styles.filterButtonActive]}
                    onPress={() => setSelectedCategory('phone')}
                >
                    <Text style={[styles.filterText, selectedCategory === 'phone' && styles.filterTextActive]}>
                        Thẻ điện thoại
                    </Text>
                </TouchableOpacity>
            </View>
                        ...
                        {selectedReward && (
                            <>
                                <Text style={styles.modalDescription}>
                                    Bạn có chắc chắn muốn đổi {selectedReward.title} với {selectedReward.points} điểm?
                                </Text>
                                <TouchableOpacity
